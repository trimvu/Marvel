...
const EventsCards = ({comicID}) => {
  ...
  const eventsDetail = async () => {
    ...
    const url = `https://gateway.marvel.com:443/v1/public/comics/${comicID}/events?apikey=${API_KEY}&limit=4&offset=${items_events}`
