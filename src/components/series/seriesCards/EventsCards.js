...
const EventsCards = ({seriesID}) => {
  ...
  const eventsDetail = async () => {
    ...
    const url = `https://gateway.marvel.com:443/v1/public/series/${seriesID}/events?apikey=${API_KEY}&limit=4&offset=${items_events}`
