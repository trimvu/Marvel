...
const CharactersCards = ({seriesID}) => {

  // console.log("series ID is: ", seriesID)
  ...
  const charactersDetail = async () => {
    ...
    const url = `https://gateway.marvel.com:443/v1/public/series/${seriesID}/characters?apikey=${API_KEY}&limit=4&offset=${items_characters}`
