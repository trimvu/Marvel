...
const ComicCards = ({seriesID}) => {
  ...
  const comicDetail = async () => {
    ...
    const url = `https://gateway.marvel.com:443/v1/public/series/${seriesID}/comics?apikey=${API_KEY}&limit=4&offset=${items_comic}`
