...
const CreatorsCards = ({seriesID}) => {
  ...
  const creatorsDetail = async () => {
    ...
    const url = `https://gateway.marvel.com:443/v1/public/series/${seriesID}/creators?apikey=${API_KEY}&limit=4&offset=${items_creators}`
