...
const SeriesCards = ({eventsID}) => {
    ...
    const seriesDetail = async () => {
        ...
        const url = `https://gateway.marvel.com:443/v1/public/events/${eventsID}/series?apikey=${API_KEY}&limit=4&offset=${items_series}`
